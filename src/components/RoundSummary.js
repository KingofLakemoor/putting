  ...
  return (
    <div className="min-h-screen bg-dark-bg text-white p-6 flex flex-col font-sans">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-dark-surface border border-slate-800 p-6 rounded-2xl text-center relative overflow-hidden">
          {isPB && (
          ...
          <p className={`text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-1 ${isPB ? 'mt-3' : ''}`}>Total Score</p>
          <p className="text-5xl font-data font-black text-white">{totalScore}</p>
        </div>
        <div className="bg-dark-surface border border-slate-800 p-6 rounded-2xl text-center">
          <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-1">Birdies</p>
          <p className="text-5xl font-data font-black text-kelly-green">{birdies}</p>
        </div>
      </div>
